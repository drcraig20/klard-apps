/**
 * Klard Design System - Effect Tokens
 *
 * SOLID Compliance:
 * - SRP: Only visual effects (glows, shadows, blur, focus)
 * - OCP: Extend by adding new effect types, not modifying existing
...
export const glassmorphism = {
  /** Blur values for different component types */
  blur: {
    card: '24px',
    nav: '12px',
    modal: '24px',
  ...
  /** Glass background colors per theme */
  background: {
  ...
  /** Backdrop overlay for dimming behind modals */
  backdrop: {
...
export const glowEffects = {
  ...
  /** Dark theme glow values (more vibrant) */
  dark: {
