...
**Tech Stack:**
- Web: Next.js 16 + React 19 + Radix UI Avatar (via existing Avatar component)
- Mobile: React Native + Expo 54 + expo-image (via existing Avatar component)
...
- [ ] All sizes functional (xs, sm, md, lg)
...
**Web:**
- Existing Avatar component (already implemented)
